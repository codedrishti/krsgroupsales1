                    ...
                    <div className="container clearfix">
                        ...
                        <div className={`header-nav navbar-collapse collapse justify-content-end ${show ? "show" : ""}`} id="navbarNavDropdown">
                            ...
                            <ul className="nav navbar-nav navbar">	
                                ...
                                <li><Link href="#proIntro"><a>Property</a></Link></li>
                                <li><Link href="#ourTestimonial"><a>Testimonial</a></Link></li>
                                <li><Link href="#aminities-sec"><a>Aminities</a></Link></li>
                                <li><Link href="#gallery"><a>Gallery</a></Link></li>
                                <li><Link href="#faq-sec"><a>FAQ</a></Link></li>
                            </ul>
